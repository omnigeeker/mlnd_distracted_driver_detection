...
def write_gap(MODEL, image_size, lambda_func=None):
    ...
    batch_size = 16
    train_generator = train_gen.flow_from_directory(os.path.join(dir, 'train'), image_size, shuffle=False, batch_size=batch_size, save_to_dir="save_images/train")
    ...
    with h5py.File("models/new/bottleneck_%s.h5" % MODEL.__name__) as h:
...
def write_gap_test(MODEL, image_size, lambda_func=None):
    ...
    print("begin create database {}".format(Model.__name__))
    with h5py.File("models/new/bottleneck_%s_test.h5" % MODEL.__name__) as h:
...
print("===== Train & Valid =====")
write_gap(ResNet50, (224, 224), normal_preprocess_input)
write_gap(Xception, (299, 299), xception.preprocess_input)
write_gap(InceptionV3, (299, 299), inception_v3.preprocess_input)
write_gap(VGG16, (224, 224), normal_preprocess_input)
write_gap(VGG19, (224, 224), normal_preprocess_input)

print("===== Test =====")
write_gap_test(ResNet50, (224, 224), normal_preprocess_input)
...
write_gap_test(VGG16, (224, 224), normal_preprocess_input)
write_gap_test(VGG19, (224, 224), normal_preprocess_input)